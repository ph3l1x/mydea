...
function _maximenu_block_options($menu_content = array(), $settings = array()) {
  ...
  $output_options  = isset($settings['outputs']) ? $settings['outputs']: '';
    ...
    $form_new['region'] = array(
      '#type'  => 'select',
      '#title' => t('Region'),
      '#options' => $regions,    
      '#default_value' => isset($menu_content['region']) ? $menu_content['region']: '', 
      '#description' => t('Select theme region.'),                   
    ); 
    $form_new['weight'] = array(
      '#type'  => 'weight',
      '#title' => t('Block Weight'),
      '#delta' => 200,  
      '#default_value' => isset($menu_content['weight']) ? $menu_content['weight']: 0, 
