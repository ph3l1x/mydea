<?php
/**
 * @file maximenu-accordion.tpl.php
...
<dl id="menu-<?php print $maximenu_name; ?>" class="easy-accordion">
  <?php foreach ($links['links'] as $key => $content): ?>
    <?php print theme('maximenu_accordion_links', array('content' => $content, 'maximenu_name' => $maximenu_name, 'key' => $key)); ?>          
  <?php endforeach; ?>
</dl><!-- /.easy-accordion -->    
