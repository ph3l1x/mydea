<?php
/**
 * @file maximenu-accordion_links.tpl.php
 * Default theme implementation of om maximenu links with accordion blocks
 *
 * Available variables:
 * - $accordion_dt: rendered dt with attributes
...
<?php if (!empty($permission)): ?>   
  <?php print $accordion_dt; ?>
  <dd><?php print theme('maximenu_accordion_content', array('content' => $content['content'], 'maximenu_name' => $maximenu_name, 'key' => $key)); ?></dd> 
<?php endif; ?>  
