<?php
/**
 * @file maximenu-roundabout.tpl.php
...
<ul id="menu-<?php print $maximenu_name; ?>">
  <?php foreach ($links['links'] as $key => $content): ?>
    <?php $count++; ?>
    <?php print theme('maximenu_roundabout_links', array('content' => $content, 'maximenu_name' => $maximenu_name, 'key' => $key, 'code' => $code, 'count' => $count, 'total' => $total)); ?>          
  <?php endforeach; ?>
</ul><!-- /#menu-[menu name] -->    
