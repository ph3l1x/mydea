 ...
 *
 */  
function _maximenu_drop_options($menu_content = array(), $settings = array()) {
  ...
  $form_new['stay'] = array(
    '#type'  => 'checkbox',
    '#title' => t('Stay is available'),
    '#default_value' => isset($menu_content['stay']) ? $menu_content['stay']: 1,
    '#description' => t('Enable/Disable the "Stay" checkbox for the final user to force each submenu to remain open.'),
  );
