...
jQuery(document).ready(function($){  
	...
	$('.maximenu li.leaf a').addClass('autoscroll');

	$('a.autoscroll[href*=#]').click(function() {
	...
	// stay open
	$('.maximenu-open input').each(function() {
	...
	$('.maximenu-open input').click(function() {
		//alert($(this).attr('checked'));
	  if(($(this).attr('checked') == true) || ($(this).attr('checked') == 'checked')) {
	    $(this).parent().parent().addClass('open');
	    $(this).parent().parent().parent().addClass('open');
  ...
  $('.maximenu img.hover').hover(function () {
